import { CRow, CCol, CTable, CTableHead, CTableRow, CTableHeaderCell, CTableDataCell, CTableBody } from '@coreui/react'
    ...
    return(
        <CRow>
            <CCol xs={18}>
             ...
             width:'60%', padding:'10px',borderRadius:'8px', maxHeight: '185px',
             overflow:'auto'}}>
            ...
            <p style={{marginLeft: '30px'}}>Due next month</p>
             ...
             width:'40%', padding:'10px',borderRadius:'8px'
               ...
               <div className='d-flex'>
               <div className='invoice ' style={{border: '1px solid #fff', background: '#fff', marginTop: '-40px', 
             width:'60%', padding:'10px',borderRadius:'8px', maxHeight: '280px'}}>
              <h5>History</h5>
        ...
        <p style={{marginLeft: '20px', fontSize: '18px', fontWeight: '500px'}}>Invoice {billing.invoiceNumber} <br />
            ...
            <div className='billing-bar d-flex'>
                <div className='invoice' style={{border: '1px solid #fff', background: '#fff', marginTop: '5px', 
             width:'59%', padding:'10px',borderRadius:'8px', maxHeight: '200px',
             overflow:'auto'}}>
                <h5>Items</h5>
                ...
                <CTable>
                    ...
                    <CTableBody>
                        <CTableRow>
                        <CTableDataCell>Pastry</CTableDataCell>
